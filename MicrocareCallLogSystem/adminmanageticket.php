...
$result = mysqli_query($mysqli, "SELECT * FROM table_generateticket ORDER BY ticketgenrationdate DESC"); 
?>
<!DOCTYPE html>
...
<body>
	...
	while($res = mysqli_fetch_array($result)) { 		
		...
		echo "<td>".$res['customermobile']."</td>";
		echo "<td>".$res['problemdetails']."</td>";
		echo "<td>".$res['solutiondetails']."</td>";
		echo "<td>".$res['ticketgenrationdate']."</td>";
