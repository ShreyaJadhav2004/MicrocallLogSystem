...
{
	if(empty($productname) || empty($customername) || empty($customermobile) || empty($problemdetails) || empty($solutiondetails))
	{
	...
	{
		$sql="UPDATE table_generateticket SET productname='$productname',customername='$customername',customermobile='$customermobile',problemdetails='$problemdetails',solutiondetails='$solutiondetails' WHERE ticketid=$id";
...
$result = mysqli_query($mysqli, "SELECT * FROM table_generateticket WHERE ticketid=$id");
...
while($res = mysqli_fetch_array($result))
{
	...
	$ticketdate = $res['ticketgenrationdate'];
